...
#include "InterfaceRegressionPhaseSystem.H"
...
Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::rDmdt
(
...
template<class BasePhaseSystem>
Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::InterfaceRegressionPhaseSystem
(
    const fvMesh& mesh
)
:
...
template<class BasePhaseSystem>
Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::
~InterfaceRegressionPhaseSystem()
{}
...
Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::saturation() const
{
...
template<class BasePhaseSystem>
Foam::tmp<Foam::volScalarField>
Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::dmdt
(
    const phasePairKey& key
) const
{
...
Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::dmdts() const
{
...
Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::massTransfer() const
{
...
Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::heatTransfer() const
{
...
Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::momentumTransfer()
{
...
template<class BasePhaseSystem>
void Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::solve()
{
...
template<class BasePhaseSystem>
void Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::correct()
{
...
template<class BasePhaseSystem>
void Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::store()
{
...
template<class BasePhaseSystem>
void Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::calculateVelocity()
{
...
template<class BasePhaseSystem>
bool Foam::InterfaceRegressionPhaseSystem<BasePhaseSystem>::read()
{
